...
describe('ExportPesajesExcelUseCase', () => {
  ...
  beforeEach(() => {
    ...
    mockExporter = { generate: jest.fn() } as any;
  ...
  it('debería buscar todos los pesajes y generar el excel', async () => {
    const pesaje = new Pesaje({
      ...
      recuperador: { id: 'rec-1', name: 'Juan', lastName: 'Pérez', dni: '12345678' },
    });
    ...
    expect(mockPesajeRepo.findAll).toHaveBeenCalledWith({ page: 1, limit: 10000 });
