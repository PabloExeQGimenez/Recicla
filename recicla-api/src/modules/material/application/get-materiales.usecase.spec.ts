...
describe('GetMaterialesUseCase', () => {
  ...
  it('debería retornar la lista de materiales', async () => {
    const materials = [
      new Material({ id: 'm-1', name: 'Cartón', currentPrice: 2, active: true, createdAt: new Date(), updatedAt: new Date() }),
      new Material({ id: 'm-2', name: 'Plástico', currentPrice: 3, active: true, createdAt: new Date(), updatedAt: new Date() }),
    ];
